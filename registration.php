...
<div class="mainform">
	<form method="POST" id="AuthN">
        ...
        <div class="mb-3">
   			<input type="text" class="form-control" name="permissions" placeholder="Введите подразделения">
		</div>
 		</div>
 		<div class="btn-cont">
 		<button type="submit" name="button_id" class="btn btn-primary" id="sub">Создать</button>
 		</div>
	</form>
</div>
